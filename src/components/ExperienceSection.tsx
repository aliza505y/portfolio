...
const journey: RouteStop[] = [
  ...
  },
  {
    id: '02',
    year: '2026',
    title: 'PUBLISHED ANDROID APPLICATIONS',
    organization: 'GOOGLE PLAY STORE',
    description: 'Designed, developed, tested, and published Android applications including Memes4U and Status Saver, gaining practical experience with production releases, Google Play Console, app signing, and deployment.',
  },
  {
    id: '03',
    year: '2025 - PRESENT',
