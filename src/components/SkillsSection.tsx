...
const bentoCategories = [
  ...
  },
  {
    ...
    description:
      'Integrating cloud services and REST APIs into mobile applications, including authentication, realtime data, storage, JSON handling, and location-based functionality.',
  ...
  },
  {
    ...
    description:
      'Working with local and relational databases while following structured development practices including MVVM, version control, UI/UX implementation, debugging, and performance optimization.',
    stat: 'DATA + ENGINEERING',
    colSpan: 'lg:col-span-7',
  },
];
...
export const SkillsSection: React.FC = () => {
  ...
  return (
    <section
      id="skills"
      className="relative w-screen bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black  pb-24 px-6 sm:px-12 lg:px-20 overflow-hidden flex flex-col justify-center"
    >
      {/* Ambient Glows */}
